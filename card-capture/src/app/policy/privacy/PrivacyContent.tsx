    ...
    <div className="h-screen w-screen overflow-y-scroll font-Pretendard">
      ...
      <div className="mt-[60px]">
        <div className="flex flex-col px-10 py-5">
          ...
          <br />
          만들다람쥐(이하 ‘회사'라고 함)는 회사가 제공하고자 하는 서비스(이하 ‘회사 서비스’)를 이용하는 개인(이하
          ...
          회사는 이용자가 언제든지 쉽게 본 방침을 확인할 수 있도록 회사 홈페이지 첫 화면을 포함하여 첫 화면과 연결된
          ...
          - 필수 수집 정보: 카드번호, 카드비밀번호 앞 두자리, 유효기간, 은행명 및 계좌번호
          <br />
          - 선택 수집 정보: 생년월일 6자리(yy/mm/dd, 정기 결제에 한함)
          <br />
          <br />
          ...
          <br />
          - 수집목적: 포스터를 생성하는 AI 모델 개선을 위한 연구
          <br />
          - 수집정보: 포스터, 포스터 제작 시 입력한 문구, 목적, 색상, 요소(인물, 사물 등), 사이트에서 발생하는 데이터 중
          공개적으로 조회할 수 있는 게시글, 댓글 등<br />
          <br />
          ...
          <br />
          - 회사가 재화 등의 거래관계를 통하여 수신자로부터 직접 연락처를 수집한 경우, 거래가 종료된 날로부터 6개월
          ...
          <br />- Edge : 웹브라우저 우측 상단의 설정 메뉴 {'>'} 쿠키 및 사이트 권한 {'>'} 쿠키 및 사이트 데이터 관리 및
          삭제
          <br />- Chrome : 웹브라우저 우측 상단의 설정 메뉴 {'>'} 개인정보 및 보안 {'>'} 쿠키 및 기타 사이트 데이터
          <br />- Whale : 웹브라우저 우측 상단의 설정 메뉴 {'>'} 개인정보 보호 {'>'} 쿠키 및 기타 사이트 데이터
          <br />
          <br />
